...
const CountdownTimer = () => {
    let days = Math.floor((new Date("2021-10-01") - new Date()) / 86400000);
    let hours = Math.floor(((new Date("2021-10-01") - new Date()) % 86400000) / 3600000);
    let minutes = Math.floor((((new Date("2021-10-01") - new Date()) % 86400000) % 3600000) / 60000);
    let seconds = Math.floor(((((new Date("2021-10-01") - new Date()) % 86400000) % 3600000) % 60000) / 1000);
